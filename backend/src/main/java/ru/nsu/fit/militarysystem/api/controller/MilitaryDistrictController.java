...
public class MilitaryDistrictController {
    ...
    public ResponseEntity<Page<MilitaryDistrictDto>> getAllMilitaryDistrictsByFilter(@RequestObjectParam MilitaryDistrictSearchFilter militaryDistrictSearchFilter)
    ...
    public ResponseEntity<MilitaryDistrictDto> getMilitaryDistrictById(@PathVariable("id") short id)
            throws EntityNotFoundException {
    ...
    public ResponseEntity<MilitaryDistrictDto> createMilitaryDistrict(@RequestBody MilitaryDistrictDto militaryDistrictDto) throws
            EntityAlreadyExistsException {
        return new ResponseEntity<>(militaryDistrictService.createMilitaryDistrict(militaryDistrictDto), HttpStatus.CREATED);
    }

    @PutMapping(PUT_MILITARY_DISTRICT)
    public ResponseEntity<MilitaryDistrictDto> updateMilitaryDistrictById(@PathVariable("id") short id,
                                                                          @RequestBody MilitaryDistrictDto militaryDistrictDto)
            throws EntityNotFoundException {
    ...
    public ResponseEntity<MilitaryDistrictDto> deleteMilitaryDistrictById(@PathVariable("id") short id)
            throws EntityNotFoundException {
