...
public class DislocationController {
    ...
    public ResponseEntity<Page<DislocationDto>> getAllDislocationsByFilter(@RequestObjectParam DislocationSearchFilter dislocationSearchFilter)
    ...
    public ResponseEntity<DislocationDto> getDislocationById(@PathVariable("id") int id) throws EntityNotFoundException {
    ...
    public ResponseEntity<DislocationDto> createDislocation(@RequestBody DislocationDto dislocationDto) throws EntityAlreadyExistsException {
        return new ResponseEntity<>(dislocationService.createDislocation(dislocationDto), HttpStatus.CREATED);
    }

    @PutMapping(PUT_DISLOCATION)
    public ResponseEntity<DislocationDto> updateDislocationById(@PathVariable("id") int id, @RequestBody DislocationDto dislocationDto)
            throws EntityNotFoundException {
    ...
    public ResponseEntity<DislocationDto> deleteDislocationById(@PathVariable("id") int id) throws EntityNotFoundException {
